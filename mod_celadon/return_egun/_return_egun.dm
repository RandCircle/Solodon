...
/datum/modpack/return_egun
	name = "Return energy gun old"
	desc = "Этот мод возвращает energy gun старого образца."
	author = "MrCat15352"
...
// Инициализация ДО
/datum/modpack/return_egun/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/return_egun/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/return_egun/post_initialize()
	. = ..()

...
/obj/item/reagent_containers/food/snacks/snowcones/rainbow
	...
	list_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/laughter = 25)	//list_reagents = list(/datum/reagent/consumable/nutriment = 5, /datum/reagent/consumable/honey = 5, /datum/reagent/consumable/sugar = 10)	// [CELADON-ADD] - CELADON_RETURN_CONTENT_CLOWNS
